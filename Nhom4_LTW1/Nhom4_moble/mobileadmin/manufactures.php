					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tr class="">
								<td>5</td>
								<td>Oppo</td>
								<td><img src="public/image/fb_1200x628.jpg" style="width:100px"></td>
								<td>
							...
							<tr class="">
								<td>4</td>
								<td>SamSung</td>
								<td><img src="public/image/BrandLogos-SAMSUNG-Retina-COLOR.jpg" style="width:100px"></td>
								<td>
									<a href="#" class="btn btn-success btn-mini">Edit</a>
									<a href="#" class="btn btn-danger btn-mini">Delete</a>
								</td>
							...
							<tr class="">
								<td>3</td>
								<td>Sony</td>
								<td><img src="public/image/sony-og.jpg" style="width:100px"></td>
								<td>
									<a href="#" class="btn btn-success btn-mini">Edit</a>
									<a href="#" class="btn btn-danger btn-mini">Delete</a>
								</td>
							...
							<tr class="">
								<td>2</td>
								<td>Xiaomi</td>
								<td><img src="public/image/mi.jpg" style="width:100px"></td>
								<td>
									<a href="#" class="btn btn-success btn-mini">Edit</a>
									<a href="#" class="btn btn-danger btn-mini">Delete</a>
								</td>
							...
							<tr class="">
								<td>1</td>
								<td>Apple</td>
								<td><img src="public/image/open_graph_logo.jpg" style="width:100px"></td>
								<td>
									<a href="#" class="btn btn-success btn-mini">Edit</a>
									<a href="#" class="btn btn-danger btn-mini">Delete</a>
